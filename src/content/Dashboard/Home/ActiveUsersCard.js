...
function ActiveUserCard() {
  ...
  const chartData = [
    {
      name: 'Net Profit',
      data: [200,100,400,300,400,500,400,200,600,300]
    }
        ...
        >
          <Grid  container>
            ...
            <Grid item sm={3} sx={{display:'flex',flexDirection:'column',alignItems:'center'}}>
                ...
                <Box sx={{background:'#0075FF',borderRadius:'5px',padding:' 5px',display:'flex',alignItems:'center'}}>
                    <Home sx={{color:'white',fontSize:'14px'}}/></Box>
            ...
            <Box sx={{display:'flex',alignItems:'center'}}>
                <Box sx={{background:'#0075FF',borderRadius:'5px',padding:' 3px',display:'flex',alignItems:'center'}}>
                    <Home sx={{color:'white',fontSize:'14px'}}/></Box>
              <Typography variant="subtitle2" gutterBottom>
                {t('Sales')}
              </Typography>
            ...
            <Box sx={{display:'flex',alignItems:'center'}}>
                <Box sx={{background:'#0075FF',borderRadius:'5px',padding:' 5px',display:'flex',alignItems:'center'}}>
                    <Home sx={{color:'white',fontSize:'14px'}}/>
                    </Box>
              <Typography variant="subtitle2" gutterBottom>
                {t('Items')}
              </Typography>
