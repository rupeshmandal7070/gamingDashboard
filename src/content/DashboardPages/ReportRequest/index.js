    ...
    <Box sx={{margin:'0px 30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Your Listed Report & Request</Typography>
            </Box>

            <Box sx={{width:'40%',display:'flex',gap:'10px',justifyContent:'end'}}>
          
          <Box sx={{width:'40%'}}>
            <Button  variant='outlined' size='small' sx={{width:'140px'}}>Report a Bug</Button>
