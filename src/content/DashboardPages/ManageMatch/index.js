    ...
    <Box sx={{margin:'0px 30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box sx={{width:'30%'}}>
            <Button onClick={handleOpen} variant='outlined' size='small' sx={{width:'110px'}}>+ Add New</Button>
                ...
                <Table>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('Match Title')}</TableCell>
                      <TableCell>{t('Category|League')}</TableCell>
                      <TableCell>{t('Start At|End At')}</TableCell>
                      <TableCell>{t('Staus')}</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
...
ManageMatch.propTypes = {
  users: PropTypes.array.isRequired
};

ManageMatch.defaultProps = {
  users: []
};
