...
<Grid item xs={12} sx={{marginTop:'30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Hot & New Casino</Typography>
            </Box>
...
HotNewCasino.propTypes = {
  users: PropTypes.array.isRequired
};

HotNewCasino.defaultProps = {
  users: []
};

export default HotNewCasino;
