...
<Grid item xs={12} sx={{marginTop:'30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Affiliate Section</Typography>
            </Box>
          ...
          <Box sx={{width:'30%'}}>
            ...
            <Dialog open={open} onClose={handleClose}>
                 <AffiliateDialog setOpen={setOpen}/>
            </Dialog>
          </Box>
           {!selectedBulkActions && (
            <TextField
                ...
                <Table>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('level no')}</TableCell>
