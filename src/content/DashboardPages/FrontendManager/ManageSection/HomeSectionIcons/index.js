...
<Grid item xs={12} sx={{marginTop:'30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Home Section Icons</Typography>
            </Box>
...
HomeSectionIcon.propTypes = {
  users: PropTypes.array.isRequired
};

HomeSectionIcon.defaultProps = {
  users: []
};
