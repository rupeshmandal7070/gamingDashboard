...
<Grid item xs={12} sx={{marginTop:'30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Counter Section</Typography>
            </Box>
                ...
                <Table>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('counter icon')}</TableCell>
                      <TableCell>{t('sub title')}</TableCell>
                      <TableCell>{t('counter digit')}</TableCell>
