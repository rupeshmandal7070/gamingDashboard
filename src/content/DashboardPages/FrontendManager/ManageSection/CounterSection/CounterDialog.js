  ...
  return (
    ...
    <Box sx={{padding:'20px',width:'500px'}}>
           <Box sx={{display:'flex',justifyContent:'space-between'}}>
            <Typography variant='h4'>Add New Counter Item</Typography>
            <Close onClick={handleClose} sx={{cursor:'pointer'}}/>
           </Box>

           <Box sx={{marginTop:'40px',display:'flex',flexDirection:'column',gap:'30px'}}>
              <Box>
                <Typography>Counter Icon</Typography>
              ...
              <Box>
                <Typography>Counter Digit</Typography>
                <TextField variant='outlined' label='details' size='small' sx={{width:'100%','& fieldset':{borderRadius:'4px'}}}/>
              </Box>
{/* 
              <Box>
