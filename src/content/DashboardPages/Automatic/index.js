    ...
    <Box sx={{margin:'0px 30px'}}>
      ...
      {toggleView === 'table_view' && (
        <Card>
          ...
          <Box>
            <Typography variant='h3'>Automatic Gateways</Typography>
            </Box>
            {!selectedBulkActions && (
              <TextField
                sx={{
                ...
                <Table>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('Supported Currency')}</TableCell>
                      <TableCell>{t('Enabled Currency')}</TableCell>
...
AutomaticGateways.propTypes = {
  users: PropTypes.array.isRequired
};

AutomaticGateways.defaultProps = {
  users: []
};
